...
public class App extends Application {
    ...
    //App credentials
    private static final String APPLICATION_ID = "78007";
    private static final String AUTH_KEY = "hkFMTtD-mEZwgkU";
    private static final String AUTH_SECRET = "K5yJR8fgdYgsaaY";
    private static final String ACCOUNT_KEY = "kUzCpPzgL8YVwBhZnnpM";
